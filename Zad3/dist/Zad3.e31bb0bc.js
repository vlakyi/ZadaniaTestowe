...
},{"./bundle-url":"../../../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/basiclightbox/dist/basicLightbox.min.css":[function(require,module,exports) {
...
var ul = document.querySelector('ul'); // referencje żeby zrobić cleanup observera

var lastObserver;
var target; // configuracja pixabay

var keyWord = '';
var pageID = 1; // opcje observera

var options = {
  threshold: 1
}; // Github Pages nie wspiera environmental variables :(

var API_KEY = '22179498-1d5aa5cb96baf3342e8fd7cca';
...
var addImagesToList = function addImagesToList(images) {
  images.forEach(function (_ref) {
    var largeImageURL = _ref.largeImageURL,
        webformatURL = _ref.webformatURL,
        tags = _ref.tags;
    var li = document.createElement('li');
    var a = document.createElement('a');
    a.href = largeImageURL; // Tworzenie obrazu

    var img = document.createElement('img');
    img.src = webformatURL;
    img.alt = tags;
    img.setAttribute('data-source', largeImageURL); // dodanie elementów do ul

    a.appendChild(img);
    li.appendChild(a);
    ul.appendChild(li); // Otwieranie lightBox'a na click

    a.addEventListener('click', function (e) {
      e.preventDefault();
      var instance = basicLightbox.create("\n      <div class=\"modal\">\n          <img src=".concat(largeImageURL, "/>\n      </div>\n  "));
      instance.show();
    });
  });
...
var fetchImagesAndAddToList = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var keyWordQuery, res, _yield$res$json, hits;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            keyWordQuery = keyWord ? "&q=".concat(keyWord.split(' ').join('+')) : '';
            _context.next = 4;
            return fetch("https://pixabay.com/api/?key=".concat(API_KEY, "&page=").concat(pageID).concat(keyWordQuery));
  ...
  return function fetchImagesAndAddToList() {
  ...
  return new IntersectionObserver(function (entries, observer) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting && entry.intersectionRect.width > 0) {
        ...
        fetchImagesAndAddToList().then(function () {
...
var initInfiniteScroll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetchImagesAndAddToList();
  ...
  return function initInfiniteScroll() {
    return _ref3.apply(this, arguments);
  };
}();
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","basiclightbox":"node_modules/basiclightbox/dist/basicLightbox.min.js","basiclightbox/dist/basicLightbox.min.css":"node_modules/basiclightbox/dist/basicLightbox.min.css"}],"../../../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/Zad3.e31bb0bc.js.map